				...
				L.bind(function(loc) {
					if ( loc.coords.accuracy < 100 || this.watchCounter >= 0)
					{
						...
						var params = GSI.GLOBALS.queryParams.params;
								...
								var markerList = document.markerList;
								if (!markerList) {
								document.markerList = L.layerGroup();
									markerList = document.markerList;
								markerList.addTo(map);
								}
...
GSI.BaseLayer = L.TileLayer.extend({
	...
	baseLayerList : null,
	activeIndex : 0,
	isGrayScale : false, // mod by @taisukef
	opacity : 1,
	highQuality : false,
